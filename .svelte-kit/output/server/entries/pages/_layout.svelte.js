...
const css = {
  code: '.modal.svelte-1750l3h{background-color:#e1eef6;position:fixed;z-index:1000;top:50%;left:50%;width:0;height:0;transform:translate(-50%, -50%);transform-origin:center;content:" ";overflow:hidden;background:#16222a;background:linear-gradient(to left, #16222a, #3a6073);background-size:cover !important;background-image:url(${colorStatic});background-origin:border-box;color:#e1eef6;transition:width 0.2s,\n      height 0.2s;display:flex;flex-direction:column;justify-content:center;align-items:center}.modal-backdrop.svelte-1750l3h{position:fixed;z-index:0;top:0;left:0;width:100vw;height:100vh}.close-btn.svelte-1750l3h{position:absolute;top:42px;right:42px;background:transparent;border:none;color:#e1eef6;font-size:1.5rem;cursor:pointer;opacity:0}.modal-content.svelte-1750l3h{position:relative;z-index:1;padding:20px;color:#e1eef6;opacity:0;width:0;height:100%}',
  map: '{"version":3,"file":"Modal.svelte","sources":["Modal.svelte"],"sourcesContent":["<script>\\n  // @ts-nocheck\\n  import { tick, onDestroy } from \\"svelte\\";\\n  import { gsap, Power1, Power2 } from \\"gsap\\";\\n  import { closeModal } from \\"$lib/stores/modalStore\\";\\n  import colorStatic from \\"$lib/images/color-static.gif\\";\\n\\n  export let show = false;\\n  export let content = null;\\n  export let props = {};\\n\\n  let isClosing = false;\\n  let isAnimating = false;\\n  let isInitialized = false;\\n  let wasShow = false;\\n  /**\\n   * @type {gsap.core.Timeline}\\n   */\\n  let timeline;\\n\\n  const SELECTOR_MODAL_ELEMENT = \\".modal\\";\\n  const SELECTOR_MODAL_CLOSE_BUTTON = \\".close-btn\\";\\n  const SELECTOR_CONTENT_ELEMENT = \\".modal-content\\";\\n\\n  // Watcher for show changes\\n  $: if (show !== wasShow) {\\n    wasShow = show;\\n    handleShowChange();\\n  }\\n\\n  // Handle show changes\\n  function handleShowChange() {\\n    if (show && !isAnimating) {\\n      if (!isInitialized) {\\n        tick().then(() => {\\n          initializeTimeline();\\n          toggleModalAnimation();\\n        });\\n      } else {\\n        toggleModalAnimation();\\n      }\\n    } else if (!show && isClosing && !isAnimating) {\\n      toggleModalAnimation();\\n    }\\n  }\\n\\n  // Initialize GSAP timeline\\n  function initializeTimeline() {\\n    timeline = gsap.timeline({ paused: true });\\n\\n    timeline\\n      .to(SELECTOR_CONTENT_ELEMENT, {\\n        duration: 0.2,\\n        opacity: 0,\\n        width: \\"0\\",\\n        height: \\"0\\",\\n      })\\n      .to(SELECTOR_MODAL_ELEMENT, {\\n        duration: 0.2,\\n        width: \\"100vw\\",\\n        height: \\"2px\\",\\n        background: \\"#ffffff\\",\\n        ease: Power2.easeOut,\\n      })\\n      .to(SELECTOR_MODAL_ELEMENT, {\\n        duration: 0.2,\\n        backgroundImage: `url(${colorStatic})`,\\n        ease: Power2.easeInOut,\\n      })\\n      .to(SELECTOR_MODAL_ELEMENT, {\\n        duration: 0.2,\\n        height: \\"100vh\\",\\n        ease: Power2.easeInOut,\\n      })\\n      .to(SELECTOR_MODAL_ELEMENT, {\\n        duration: 0.2,\\n        width: \\"100vw\\",\\n        height: \\"100vh\\",\\n      })\\n      .to(SELECTOR_CONTENT_ELEMENT, {\\n        duration: 0.2,\\n        width: \\"auto\\",\\n        height: \\"auto\\",\\n      })\\n      .to(SELECTOR_CONTENT_ELEMENT, {\\n        duration: 0.4,\\n        opacity: 1,\\n        ease: Power1.easeIn,\\n      })\\n      .to(SELECTOR_MODAL_CLOSE_BUTTON, {\\n        duration: 0.2,\\n        opacity: 1,\\n        ease: Power1.easeIn,\\n      });\\n\\n    isInitialized = true;\\n  }\\n\\n  // Toggle modal animation\\n  function toggleModalAnimation() {\\n    if (!timeline) return;\\n    isAnimating = true;\\n\\n    if (!isClosing) {\\n      document.body.style.overflow = \\"hidden\\";\\n      timeline.play().then(() => {\\n        isAnimating = false;\\n      });\\n    } else {\\n      document.body.style.overflow = \\"auto\\";\\n      timeline.reverse().then(() => {\\n        resetModalState();\\n        closeModal();\\n      });\\n    }\\n  }\\n\\n  // Close modal and toggle animation\\n  function toggleClose() {\\n    isClosing = true;\\n    toggleModalAnimation();\\n  }\\n\\n  // Reset modal state\\n  function resetModalState() {\\n    isClosing = false;\\n    isAnimating = false;\\n    isInitialized = false;\\n    show = false;\\n  }\\n\\n  // Clean up on destroy\\n  onDestroy(() => {\\n    if (timeline) {\\n      timeline.kill();\\n    }\\n  });\\n<\/script>\\n\\n{#if show}\\n  <div class=\\"modal\\">\\n    <!-- svelte-ignore a11y-click-events-have-key-events -->\\n    <!-- svelte-ignore a11y-no-static-element-interactions -->\\n    <div class=\\"modal-backdrop\\" on:click={toggleClose}></div>\\n    <button class=\\"close-btn\\" on:click={toggleClose}> Close </button>\\n    <div class=\\"modal-content\\">\\n      {#if content}\\n        <svelte:component this={content} {...props} />\\n      {/if}\\n    </div>\\n  </div>\\n{/if}\\n\\n<style>\\n  .modal {\\n    background-color: #e1eef6;\\n    position: fixed;\\n    z-index: 1000;\\n    top: 50%;\\n    left: 50%;\\n    width: 0;\\n    height: 0;\\n    transform: translate(-50%, -50%);\\n    transform-origin: center;\\n    content: \\" \\";\\n    overflow: hidden;\\n    background: #16222a;\\n    background: linear-gradient(to left, #16222a, #3a6073);\\n    background-size: cover !important;\\n    background-image: url(${colorStatic});\\n    background-origin: border-box;\\n    color: #e1eef6;\\n    transition:\\n      width 0.2s,\\n      height 0.2s;\\n    display: flex;\\n    flex-direction: column;\\n    justify-content: center;\\n    align-items: center;\\n  }\\n\\n  .modal-backdrop {\\n    position: fixed;\\n    z-index: 0;\\n    top: 0;\\n    left: 0;\\n    width: 100vw;\\n    height: 100vh;\\n  }\\n\\n  .close-btn {\\n    position: absolute;\\n    top: 42px;\\n    right: 42px;\\n    background: transparent;\\n    border: none;\\n    color: #e1eef6;\\n    font-size: 1.5rem;\\n    cursor: pointer;\\n    opacity: 0;\\n  }\\n\\n  .modal-content {\\n    position: relative;\\n    z-index: 1;\\n    padding: 20px;\\n    color: #e1eef6;\\n    opacity: 0;\\n    width: 0;\\n    height: 100%;\\n  }\\n</style>\\n"],"names":[],"mappings":"AA0JE,qBAAO,CACL,gBAAgB,CAAE,OAAO,CACzB,QAAQ,CAAE,KAAK,CACf,OAAO,CAAE,IAAI,CACb,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,GAAG,CACT,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CAAC,CACT,SAAS,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CAChC,gBAAgB,CAAE,MAAM,CACxB,OAAO,CAAE,GAAG,CACZ,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,OAAO,CACnB,UAAU,CAAE,gBAAgB,EAAE,CAAC,IAAI,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,CACtD,eAAe,CAAE,KAAK,CAAC,UAAU,CACjC,gBAAgB,CAAE,mBAAmB,CACrC,iBAAiB,CAAE,UAAU,CAC7B,KAAK,CAAE,OAAO,CACd,UAAU,CACR,KAAK,CAAC,IAAI,CAAC;AACjB,MAAM,MAAM,CAAC,IAAI,CACb,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MACf,CAEA,8BAAgB,CACd,QAAQ,CAAE,KAAK,CACf,OAAO,CAAE,CAAC,CACV,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KACV,CAEA,yBAAW,CACT,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,CACT,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,WAAW,CACvB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,OAAO,CACd,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,CACX,CAEA,6BAAe,CACb,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,OAAO,CACd,OAAO,CAAE,CAAC,CACV,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,IACV"}'
};
const SELECTOR_MODAL_ELEMENT = ".modal";
const SELECTOR_MODAL_CLOSE_BUTTON = ".close-btn";
const SELECTOR_CONTENT_ELEMENT = ".modal-content";
const Modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${show ? `<div class="modal svelte-1750l3h">  <div class="modal-backdrop svelte-1750l3h"></div> <button class="close-btn svelte-1750l3h" data-svelte-h="svelte-1418bbg">Close</button> <div class="modal-content svelte-1750l3h">${content ? `${validate_component(content || missing_component, "svelte:component").$$render($$result, Object.assign({}, props), {}, {})}` : ``}</div></div>` : ``}`;
});
