...
const Modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.show === void 0 && $$bindings.show && show !== void 0)
    $$bindings.show(show);
  if ($$props.closeModal === void 0 && $$bindings.closeModal && closeModal2 !== void 0)
    $$bindings.closeModal(closeModal2);
  ...
  return `${show ? `<div class="modal svelte-qjxjun" ${show ? "open" : ""}>  <div class="modal-backdrop svelte-qjxjun"></div> <div class="modal-content svelte-qjxjun"><button class="close-btn" data-svelte-h="svelte-16vr6xb">Close</button> ${content ? `${validate_component(content || missing_component, "svelte:component").$$render($$result, Object.assign({}, props), {}, {})}` : ``}</div></div>` : ``}`;
});
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Grid, "Grid").$$render($$result, {}, {}, {})} ${validate_component(Navigation, "Navigation").$$render($$result, {}, {}, {})} <main class="relative z-10 w-screen overflow-hidden p-8 pt-24 text-gray-200 md:pt-32">${slots.default ? slots.default({}) : ``}</main> ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})} ${validate_component(Modal, "Modal").$$render($$result, { show, closeModal, content, props }, {}, {})}`;
});
export {
  Layout as default
};
