...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let videos = [];
  return `<div class="mx-auto max-w-4xl px-4"><section class="section-glass relative mb-32 mt-3 gap-4 rounded-md p-8 text-white"><h1 class="mb-6 text-4xl font-bold" data-svelte-h="svelte-bwqu26">Videos</h1>  <div class="grid grid-cols-1 gap-4 rounded-md text-white max-md:grid-cols-1 md:grid-cols-3">${each(videos, (video) => {
