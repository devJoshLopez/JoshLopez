...
WelcomeState.prototype.draw = function (game, dt, ctx) {
    ...
    ctx.font = "30px 'Nova Square'";
    ctx.fillStyle = '#0F2643';
    ctx.textBaseline = "middle";
    ctx.textAlign = "center";
    ctx.fillText("Test Your Might", game.width / 2, game.height / 2 - 40);
...
PlayState.prototype.draw = function (game, dt, ctx) {
    ...
    ctx.font = "14px 'Nova Square'";
    ctx.fillStyle = '#DA6099';
