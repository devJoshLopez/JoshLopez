...
<div class="mx-auto max-w-4xl">
  ...
  >
    ...
    {#each sortedPosts as post, index (post.slug)}
      <div
        class="relative col-span-1 flex flex-col rounded-md border border-violet-50/20 bg-linear-to-b from-gray-50/15 to-gray-50/5 px-8 py-8 max-md:border-none max-md:bg-none max-md:p-0 {layout[
          index
        ]}"
      >
        {#if post.image}
          <div
            class="relative mb-4 shrink-0 overflow-hidden rounded-md"
